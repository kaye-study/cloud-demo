 ...
 */
public class AccessFilter01 extends ZuulFilter {

    private static final Logger log = LoggerFactory.getLogger(AccessFilter01.class);
    ...
    public boolean shouldFilter() {
        ...
        return Integer.valueOf(accessToken) > 1;
    }
    ...
    public Object run() {
        ...
        if (!"4311".equals(accessToken)) {
            ...
            ctx.setResponseBody("filter01's content is Fools are not allowed to visit");
            //设置相应类型
